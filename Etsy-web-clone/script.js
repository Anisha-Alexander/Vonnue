...
navCont.innerHTML+=` <div class="nav-header-container-mob">
            ...
            <div class="search-input-container-tab">
            <div class="search-input-container-mob" id="search-mob">
            ...
            <ul class="nav-header-left-card">
                <li><a href="#" class= "user-icon-tab"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M21.001,22c-0.339,0-0.67-0.172-0.857-0.484C18.439,18.688,15.396,17,12,17c-3.336,0-6.457,1.731-8.145,4.518 c-0.286,0.473-0.9,0.623-1.374,0.338c-0.472-0.286-0.624-0.901-0.337-1.373C4.192,17.101,7.968,15,12,15 c4.041,0,7.818,2.102,9.856,5.484c0.285,0.473,0.133,1.087-0.341,1.372C21.354,21.954,21.177,22,21.001,22z"></path><path d="M11.996,12.993C8.69,12.993,6,10.303,6,6.997C6,3.69,8.69,1,11.996,1C15.307,1,18,3.69,18,6.997 C18,10.303,15.307,12.993,11.996,12.993z M11.996,3C9.83,3,8,4.83,8,6.997c0,2.166,1.83,3.996,3.996,3.996 c2.17,0,4.004-1.83,4.004-3.996C16,4.83,14.166,3,11.996,3z"></path></svg></a></li>
                <li class="tab-none"><button id="signin-btn">${dataBase[1].header.signTxt}</button></li>
                <li class="tab-none"><a href="#" class="left-header-icon"><svg xmlns="${dataBase[1].header.likeIcon}" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12,21C10.349,21,2,14.688,2,9,2,5.579,4.364,3,7.5,3A6.912,6.912,0,0,1,12,5.051,6.953,6.953,0,0,1,16.5,3C19.636,3,22,5.579,22,9,22,14.688,13.651,21,12,21ZM7.5,5C5.472,5,4,6.683,4,9c0,4.108,6.432,9.325,8,10,1.564-.657,8-5.832,8-10,0-2.317-1.472-4-3.5-4-1.979,0-3.7,2.105-3.721,2.127L11.991,8.1,11.216,7.12C11.186,7.083,9.5,5,7.5,5Z"></path></svg></a></li>
...
footerEl.innerHTML +=`<span class="svg-border"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1400 48" preserveAspectRatio="xMidYMid slice" aria-hidden="true" focusable="false">
                    ...
                    <div id="footer-main-container">
                        ...
                        <div class="foot-nav-container" id="foot-nav-cont-id">
...
function footNavContainerHead(){
    ...
    footerNavContainer.classList.add('foot-nav-box')
 
    let navElemlen=(dataBase[5].footer.navElements).length
    console.log(navElemlen)
    console.log(dataBase[5].footer.navElements)

    const data = dataBase[5].footer.navElements

    data.forEach((element)=>{

        const mainTitle = element.title
        ...
        const elementOption = element.options
        console.log(elementOption)

        footerNavContainer.appendChild(footNavCard)

        const elementListItem = document.createElement('ul')
        elementListItem.classList.add('element-list-items')

        footNavCard.appendChild(elementListItem)
        
        elementOption.forEach((option)=>{
            console.log(option.value)
            const para = document.createElement('li')
            para.innerHTML=option.value
            elementListItem.appendChild(para)
